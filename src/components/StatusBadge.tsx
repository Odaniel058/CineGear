...
const statusConfig: Record<string, { label: string; className: string }> = {
  available: { label: 'Disponível', className: 'bg-success/15 text-success border-success/30' },
  reserved: { label: 'Reservado', className: 'bg-info/15 text-info border-info/30' },
  maintenance: { label: 'Manutenção', className: 'bg-warning/15 text-warning border-warning/30' },
  unavailable: { label: 'Indisponível', className: 'bg-destructive/15 text-destructive border-destructive/30' },
  quote: { label: 'Orçamento', className: 'bg-muted text-muted-foreground border-border' },
